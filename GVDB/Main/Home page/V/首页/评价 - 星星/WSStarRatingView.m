 ...
 */
- (id)initWithFrame:(CGRect)frame numberOfStar:(CGFloat)number
{
...
- (UIView *)buidlStarViewWithImageName:(NSString *)imageName
{
    ...
    for (int i = 0; i < self.numberOfStar; i ++){
        ...
        imageView.frame = CGRectMake(i * frame.size.width / kNUMBER_OF_STAR, 0, frame.size.width / kNUMBER_OF_STAR, frame.size.height);
