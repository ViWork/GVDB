...
#import "MenuFourCell.h"

@implementation MenuFourCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _imgCustomer.image  =[UIImage imageNamed:@"1.jpg"] ;
        ...
        _labCustomerName.text = @"和我一样打死你,信不" ;
        _labCustomerName.font = [UIFont systemFontOfSize:SIZE(26.0)] ;
        _labCustomerName.textColor = [GVColor hexStringToColor:@"#888888"] ;
        _textH1 = [SelfAdaption text:_labCustomerName.text size:ScreenWIDTH - SIZE(48.0) fontSize:26.0] ;
        ...
        _labMenuJudgeInfo = [[UILabel alloc]init];
         _labMenuJudgeInfo.text = @"爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽爽 " ;
        ...
        _labMenuJudgeInfo.lineBreakMode = UILineBreakModeHeadTruncation ;
        _textH2 = [SelfAdaption text:_labMenuJudgeInfo.text size:ScreenWIDTH - SIZE(48.0) fontSize:30.0] ;
...
-(void)layoutSubviews{
    ...
    [_imgCustomer mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.mas_top).offset(SIZE(20.0)) ;
...
//        make.bottom.mas_equalTo(self.mas_bottom).offset(SIZE(18.0)) ;
    ...
    if ([self.delegate respondsToSelector:@selector(tableRowHeight4:)]) {
        [self.delegate tableRowHeight4:self] ;
    }
}
